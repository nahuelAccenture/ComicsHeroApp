...
const CharacterByHeroe = ({alter_ego, characters})=> {
...
export const HeroCard = ({
    ...
    return (
        <div className='col animate__animated animate__rubberBand'>
            <div className='card'>
                    ...
                    <div className='col-8'>
                        <div className='card-body'>
                           ...
                           <p className='card-text'>{alter_ego}</p>
                            ...
                            <CharacterByHeroe alter_ego={alter_ego} characters={characters}/>
